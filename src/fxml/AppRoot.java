...
public class AppRoot extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		/*HBox*/Parent root = (HBox) FXMLLoader.load(getClass().getResource("Root.fxml")); //FXML을 불러오는 코드, getClass() : 현재 실행되는 클래스에  getResource("Root.fxml") : Root.fxml 파일의 리소스(파일,디렉토리 등)를 가져오겠다는 의미, 
